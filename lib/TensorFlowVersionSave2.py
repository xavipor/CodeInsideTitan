...
def train(learning_rate=0.001,num_epochs =3000,beta=0.003):
    myPathModel = '/home/jdominguezmartinez/pruebas/Microbleeds/cmb-3dcnn-code-v1.0/demo/code/lib/SavedModels/AllNetGDZ14/'
...
#	    pdb.set_trace()
	    ...
	    if epoch %25 == 0:
                saver.save(sess, myPathModel+'SecondModel_+'+str(learning_rate)+"_"+str(num_epochs)+"_"+str(beta),global_step=epoch)


            if epoch %5 ==0:
                save_to_file(myPathModel+ "ErrorV_2_"+str(learning_rate)+"_"+str(num_epochs)+"_"+str(beta),err_val)
    		save_to_file(myPathModel+ "AccV_2_"+str(learning_rate)+"_"+str(num_epochs)+"_"+str(beta),acc_val)
    		save_to_file(myPathModel+"ErrorT_2_"+str(learning_rate)+"_"+str(num_epochs)+"_"+str(beta),err_train)
    		save_to_file(myPathModel+ "AccT_2_"+str(learning_rate)+"_"+str(num_epochs)+"_"+str(beta),acc_train)
    sess.close()
